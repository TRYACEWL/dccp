    ...
    def __init__(
        ...
        try:
            tokenizer = AutoTokenizer.from_pretrained(
                '/mnt/bn/zhufangqi-lq-c2ec0f30/zhufangqi/world-model/openvla/meta-llama/Llama-2-7b-hf', model_max_length=2048, token=hf_token, padding_side="right"
            )
        except:
            tokenizer = AutoTokenizer.from_pretrained(
                '/mnt/hdfs/zhufangqi/pretrained_models/meta-llama/Llama-2-7b-hf', model_max_length=2048, token=hf_token, padding_side="right"
            )
